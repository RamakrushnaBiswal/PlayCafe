...
export default function Boardgame() {
  ...
  const calculateTransform = (index) => {
    if (hoveredIndex === index) {
      return "rotateX(14deg) rotateY(14deg)";
    }
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container mx-auto grid grid-cols-1 gap-6 px-4 md:grid-cols-2 lg:grid-cols-3 md:px-6">
            {[
              ...
              <div
                key={index}
                className="relative overflow-hidden transition-transform duration-300 ease-in-out rounded-lg shadow-lg group perspective glow-effect"
