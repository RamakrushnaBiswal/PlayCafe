          ...
          <div className="container grid grid-cols-1 gap-8 px-4 md:grid-cols-2 lg:grid-cols-1 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:grid-cols-1 xl:grid-cols-2 md:px-6 lg:px-4 xl:px-0">
              ...
              <div className="w-full lg:m-10 md:m-10">
                ...
                <h4 className="text-xl text-muted text-slate-700 italic mt-2 leading-8 ">
                  ...
                  fast-paced, high-energy play, perfect for Marvel fans and
                  those who enjoy quick and dynamic gameplay.
                </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:grid-cols-1 xl:grid-cols-2 md:px-6 lg:px-4 xl:px-0">
              <div className="w-full m-10 mx-auto lg:mx-0 md:mx-0">
                <img src={img2} alt="" className="h-[400px] w-full" />
              </div>
              <div className="w-full lg:m-10 md:m-10">
                <h1 className="text-4xl font-semibold">
                ...
                <h4 className="text-xl text-muted text-slate-700 italic mt-2 leading-8 text-wrap ">
                  Set in the world of Westeros, players represent the great
                  houses vying for control of the Iron Throne. The game captures
                  the political intrigue, warfare, and alliances from the books
                  and TV series.
                </h4>
                <div className="text-xl text-muted text-slate-700 italic mt-2 leading-8">
                  <b>Date: </b> <i>May 10, 2023</i>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:grid-cols-1 xl:grid-cols-2 md:px-6 lg:px-4 xl:px-0">
              <div className="w-full m-10 mx-auto lg:mx-0 md:mx-0">
                <img src={img3} alt="" className="h-[400px] w-full" />
              </div>
              <div className="w-full lg:m-10 md:m-10">
                <h1 className="text-4xl font-semibold">
                ...
                <h4 className="text-xl text-muted text-slate-700 italic mt-2 leading-8  ">
                  The game retains its Wild West theme, where players assume
                  roles such as Sheriff, Outlaws, Renegades, and Deputies. The
                  expansion adds a thematic layer of the board game &quot;Old
                  Saloon&quot; with new dice, characters, and modules.
                </h4>
                <div className="text-xl text-muted text-slate-700 italic mt-2 leading-8">
                  <b>Date: </b> <i>May 10, 2023</i>
                  <br />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:grid-cols-1 xl:grid-cols-2 md:px-6 lg:px-4 xl:px-0">
              ...
              <div className="w-full lg:m-10 md:m-10 ">
                ...
                <h4 className="text-xl text-muted text-slate-700 italic mt-2 leading-8 ">
                  It is a thematic and strategic board game where players
                  compete to control a mythical island rich with resources and
                  secrets. The game features a modular board, hidden objectives,
                  and more.
                </h4>
                <div className="text-xl text-muted text-slate-700 italic mt-2 leading-8">
                  <b>Date: </b> <i>May 10, 2023</i>
