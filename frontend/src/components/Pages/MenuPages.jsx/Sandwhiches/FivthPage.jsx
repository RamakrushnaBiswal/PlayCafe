...
const FivthPage = () => {
  return (
    <div className="h-full">
      <div style={sandwichStyle} className="h-full absolute inset-0 md:min-h-100vh"></div>
        ...
        <div className="md:space-y-2 space-y-0">
          ...
          <div className="p-1 flex flex-row gap-16">
            <div className="md:space-y-2 w-1/2 space-y-1">
              ...
              <div className="flex justify-between">
                <div>
                  <h2 className="md:text-xl text-xs font-semibold">Italian Panini</h2>
                  <p>$11.00</p>
                </div>
              </div>
              ...
              <div className="flex justify-between">
                <div>
                  <h2 className="md:text-xl text-xs font-semibold">Tuna Melt</h2>
              ...
              <div className="flex justify-between">
                <div>
                  <h2 className="md:text-xl text-xs font-semibold">Turkey Club</h2>
                  <p className="md:text-[16px] text-xs" >$11.00</p>
                </div>
              </div>
              ...
              <div className="md:flex hidden justify-between">
                <div>
                  <h2 className="md:text-xl text-xs font-semibold">Grilled Cheese</h2>
            ...
            <div className="space-y-2 w-1/2">
              <div className="flex justify-between">
                <div>
                  <h2 className="md:text-xl text-xs font-semibold">Cobb Salad</h2>
              ...
              <div className="flex justify-between">
                <div>
                  <h2 className="md:text-xl text-xs font-semibold">Pizza Panini</h2>
                  <p className="md:text-[16px] text-xs" >$11.00</p>
                </div>
              </div>
              ...
              <div className="flex justify-between">
                <div>
                  <h2 className="md:text-xl text-xs  font-semibold">Pigs in a Blanket</h2>
              ...
              <div className="flex justify-between">
                <div>
                  <h2 className="md:text-xl text-xs  font-semibold">Tater Tots</h2>
              ...
              <div className="flex justify-between">
                <div>
                  <h2 className="md:text-xl text-xs  font-semibold">Onion Rings</h2>
                  <p className="md:text-[16px] text-xs" >$5.00</p>
                </div>
              </div>
