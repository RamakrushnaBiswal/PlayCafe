...
const events = [
  {
    img: img1,
    title: "5-Minute MARVEL Cinematic Experience",
    description:
  ...
  {
    img: img3,
    title: "Bang! Dice Expansion: Old Saloon",
    description:
  ...
  {
    img: img5,
    title: "Chameleons: A cooperative card game",
    description:
      "Chameleons is a cooperative card game designed for fast-paced, lighthearted game where players must identify a hidden Chameleon among them using deduction, quick thinking, and clever bluffing.",
    date: "May 10, 2023",
    time: "2:00 PM - 3:30 PM",
    age: "All ages",
  },
  ...
  return (
    <>
      ...
      >
        ...
        <div className="min-h-screen bg-amber-100 p-16">
        ...
        <section
          className="w-full py-12 md:py-24 lg:py-16 flex justify-center px-16"
          id="event"
        >
          <div className="flex flex-col gap-16">
            {events.map((event, index) => (
              ...
              >
                <div className="w-1/2">
                  <img src={event.img} alt={`image${index}`} className="h-[400px] w-full rounded-lg" />
                </div>
                <div className="w-1/2">
